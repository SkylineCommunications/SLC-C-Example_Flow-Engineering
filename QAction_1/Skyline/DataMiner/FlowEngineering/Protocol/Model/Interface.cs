namespace Skyline.DataMiner.FlowEngineering.Protocol.Model
{
	...
	public class Interface : IEquatable<Interface>
    {
        ...
        public void SetStatus(SLProtocolExt protocol, InterfaceAdminStatus adminStatus, InterfaceOperationalStatus operStatus)
        {
            AdminStatus = adminStatus;
            OperationalStatus = operStatus;

            var row = new FleinterfacesoverviewtableQActionRow
            {
                Fleinterfacesoverviewtableindex = Index,
                Fleinterfacesoverviewtableadminstatus = (int)AdminStatus,
                Fleinterfacesoverviewtableoperstatus = (int)OperationalStatus,
            };

            protocol.fleinterfacesoverviewtable.SetRow(row);
        }
